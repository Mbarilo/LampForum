      ...
      <div className={styles.content}>
        ...
        <div className={styles.filters}>
          ...
          <div className={styles.likesFilter}>
            <label>
              <input type="radio" name="likes" onChange={() => setLikesMinimumValue(0)}/>All
            </label>
            <label>
              <input type="radio" name="likes" onChange={() => setLikesMinimumValue(10)}/>10+
            </label>
            <label>
              <input type="radio" name="likes" onChange={() => setLikesMinimumValue(30)}/>30+
            </label>
          </div>
        </div>
